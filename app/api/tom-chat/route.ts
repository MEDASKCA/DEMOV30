...
import { queryAzureOpenAI } from '@/lib/azureOpenAI';
...
/**
 * POST /api/tom-chat
 * TOM AI chat endpoint with Azure OpenAI + Firebase RAG
 */
...
Answer the user's question based on the context provided.`;
    ...
    // Query Azure OpenAI
    const response = await queryAzureOpenAI(message, systemPrompt);
