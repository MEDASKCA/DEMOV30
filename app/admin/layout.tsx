...
function AdminLayoutContent({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="h-screen w-screen flex flex-col overflow-hidden">
      ...
      {/* TOM by MEDASKCA Header - Only show on chat and feeds pages when no drawer is open */}
      {(currentView === 'chat' || currentView === 'feeds') && !showDrawer && (
      ...
      <div className="flex-1 flex overflow-hidden relative">
        ...
        {/* Voice Mode Button - Mobile Only - Only show when not already in voice mode */}
        {voiceState === 'idle' && !showVoiceOverlay && (
          <VoiceModeButton
            onClick={() => {
