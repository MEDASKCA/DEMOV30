...
import { ArrowLeft, CreditCard, ChevronDown, User, Settings, HelpCircle, LogOut } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="hidden md:block px-6 py-4 bg-gray-50">
        ...
        <p className="text-sm text-gray-600 mt-1">
          Surgical case preferences, procedure templates, clinical codes, and cost data
        </p>
      </div>
